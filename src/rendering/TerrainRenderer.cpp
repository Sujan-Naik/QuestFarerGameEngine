...
void TerrainRenderer::draw(glm::vec3 cameraPosition, glm::mat4 projection, glm::mat4 view, glm::vec3 offset) {
...
void TerrainRenderer::initTerrainData(std::shared_ptr<Generator> newGenerator) {
...
TerrainRenderer::TerrainRenderer(std::shared_ptr<Logger> logger, std::unique_ptr<Shader> terrainShader) : MeshRenderer(
