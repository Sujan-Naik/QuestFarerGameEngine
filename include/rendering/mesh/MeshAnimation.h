#ifndef QUESTFARERGAMEENGINE_MESHANIMATION_H
#define QUESTFARERGAMEENGINE_MESHANIMATION_H
...
namespace rendering::mesh {
    ...
    public:
        ...
        // constructor
        MeshAnimation(vector<AnimVertex>
        vertices,
        vector<unsigned int> indices, vector<Texture>
        textures)
        {
    ...
    private:
        ...
        void setupMesh() {
            ...
            glVertexAttribPointer(4, 3, GL_FLOAT, GL_FALSE, sizeof(AnimVertex),
                                  (void *) offsetof(AnimVertex, Bitangent));
            // ids
            ...
            glVertexAttribPointer(6, 4, GL_FLOAT, GL_FALSE, sizeof(AnimVertex),
...
#endif //QUESTFARERGAMEENGINE_MESHANIMATION_H
